...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一位解讀療癒者, Hi，我是一位引路人,Hi，我是一位陪伴人,Hi，希望我能夠隨行在你身旁一起成長🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '𝐂𝐡𝐥𝐨𝐫𝐢𝐬｜曉瑩', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '每朵花，都能綻放於光中🌷。解讀療癒者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://flowery-in-light.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'flowery, website', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'Laamyinging@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || '', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || '', // 你的linkedIn 首页
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || '@flowery.inlight', // 您的instagram地址
